...
const Header = () => {
  ...
  return (
    <div className='flex flex-row mainContrast pb-4 align-middle'>
      ...
      <button id='dropIt' onClick={() => setMenuDown(!menuDown)} className='clicked mt-4 ml-4 text-3xl brightContrastButtonOne p-5 py-2 rounded-md'><span id='rotateMe' className="material-symbols-outlined text-3xl">add</span></button>
      ...
      <button className='clicked mt-4 ml-4 text-3xl border-solid border-2 brightContrastButtonTwo mr-4 p-5 py-2 rounded-md' onClick={() => {setSettingsMenu(!settingsMenu)}}><span className="material-symbols-outlined">settings</span></button>
